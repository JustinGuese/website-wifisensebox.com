...
targetBuyer: Health & Safety Officers
faq:
  - q: How does it work?
...
locale: en
demoConfig:
  headerLabel: Live Occupancy Feed
  metricLabel: Persons in Space
  metricUnit: PERS
  metricBase: 2
  metricMin: 0
  metricMax: 10
  metricFooter: Automated counting in high-risk zones without manual logs.
  statusLabel: Zone Status
  statusOn: COMPLIANT
  statusOff: VARIANCE DETECTED
  secondaryLabel: Occupancy History
  privacyText: Protecting workers without invasive video monitoring.
...
### Join the WifiSenseBox Waitlist
We are currently rolling out pilot programs for industrial facilities that prioritize worker safety. By joining the waitlist, you will be considered for our next round of deployments and will receive exclusive technical briefings on our sensing technology.

**Protect your team. Automate your compliance. Secure your workspace.**
